...
menu_items = [
    {'name': 'Faucet', 'description': 'Launch native and stables faucet'},
    {'name': 'Daily check-in', 'description': 'Complete daily check-in'},
    {'name': 'On-chain tasks', 'description': 'Swap, add liquidity, send to another wallet'},
    {'name': 'Gotchipus NFT', 'description': 'Mint Gotchipus NFT'},
    {'name': 'Connect socials', 'description': 'Connect discord and twitter'},
